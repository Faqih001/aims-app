...
<template>
  <header class="flex items-center justify-between px-4 lg:px-6 h-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
    ...
    <div class="flex items-center">
      ...
      />
      <UDropdownMenu :items="dropdownItems" mode="hover" :content="{ align: 'end', class: 'w-48 sm:w-56' }" class="ml-2 lg:ml-4">
        <div class="w-full sm:w-56 flex items-center justify-between gap-2 cursor-pointer px-3 py-1.5 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
          <div class="flex items-center gap-2">
            ...
            <div class="flex flex-col text-left mr-1 lg:mr-2 hidden sm:flex">
