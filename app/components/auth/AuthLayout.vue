...
<template>
  <div class="min-h-screen flex flex-col lg:flex-row" :class="{ 'lg:flex-row-reverse': reverse }">
    <div
      class="hidden lg:block relative lg:h-auto lg:w-1/2 border-primary-900"
      :class="{ 'lg:border-r-4': !reverse, 'lg:border-l-4': reverse }"
    >
      <slot name="image" />
    </div>

    <div class="w-full lg:w-1/2 flex items-center justify-center min-h-screen lg:min-h-0 p-6 sm:p-12 xl:p-24 bg-gray-50 dark:bg-gray-900 border-t-4 border-primary-900 lg:border-t-0 relative">
